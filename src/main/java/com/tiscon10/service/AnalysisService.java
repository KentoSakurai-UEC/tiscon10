...
public class AnalysisService {
     ...
     * 
     *
     * @return 年代別分析結果を表すクラス (AnalysisResult)
     */
    public AnalysisResult getNumberOfUsersByAgeGroup() {
        ...
        List<AnalysisResult.AgeGroupData> ageGroupDataList = new ArrayList<>();
        for (Map<String, Object> row : numOfUsersByAgeGroup) {
            ...
            ageGroupDataList.add(new AnalysisResult.AgeGroupData(ageGroup, userCount));
        }
        // 年代別分析結果を返す。
        AnalysisResult analysisResult = new AnalysisResult(ageGroupDataList);
